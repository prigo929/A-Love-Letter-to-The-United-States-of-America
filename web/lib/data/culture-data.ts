...
export const BRAND_LOGOS_ROW_1 = [
  ...
  { name: "Nike", file: "Logo_NIKE.svg", invert: true, scale: "scale-80" },
  ...
  { name: "Intel", file: "intel.svg", invert: true, scale: "scale-105" },
  ...
  { name: "3M", file: "3m.svg", scale: "scale-95" },
  ...
  { name: "Electronic Arts", file: "Electronic-Arts-Logo.svg", invert: true, scale: "scale-90" },
  { name: "ExxonMobil", file: "Exxon_Mobil_Logo.svg", scale: "scale-100" },
  { name: "Goldman Sachs", file: "Goldman_Sachs.svg", scale: "scale-105" },
  { name: "Johnson & Johnson", file: "Johnson_and_Johnson_Logo.svg", scale: "scale-115" },
  { name: "Morgan Stanley", file: "Morgan_Stanley_Logo_2024.svg", invert: true, scale: "scale-100" },
  { name: "Pfizer", file: "Pfizer_(2021).svg", scale: "scale-100" },
  { name: "Pinterest", file: "Pinterest.svg", scale: "scale-85" },
  { name: "Procter & Gamble", file: "Procter_&_Gamble_logo.svg", scale: "scale-90" },
  { name: "Sony Pictures", file: "Sony_Pictures_idY2GHWY4y_1.svg", invert: true, scale: "scale-95" },
  { name: "Take-Two", file: "Take-Two_Interactive_Logo.svg", invert: true, scale: "scale-95" },
  { name: "United Parcel Service", file: "United_Parcel_Service_logo_2014.svg", scale: "scale-90" },
  { name: "Universal Pictures", file: "Universal_Pictures_idSUkJcVOK_1.svg", scale: "scale-100" },
  { name: "Valve", file: "Valve_logo.svg", invert: true, scale: "scale-95" },
  { name: "Walt Disney World", file: "Walt_Disney_World_Logo_0.svg", scale: "scale-115" },
  { name: "Abbott", file: "abbott-laboratories.svg", invert: true, scale: "scale-100" },
  { name: "AbbVie", file: "abbvie.svg", invert: true, scale: "scale-100" },
  { name: "AMD", file: "amd.svg", invert: true, scale: "scale-100" },
  { name: "American Airlines", file: "american-airlines.svg", scale: "scale-105" },
  { name: "Anthropic", file: "anthropic.svg", invert: true, scale: "scale-100" },
  { name: "AT&T", file: "att.svg", scale: "scale-90" },
  { name: "Bank of America", file: "bank-of-america.svg", scale: "scale-105" },
  { name: "Berkshire Hathaway", file: "berkshire-hathaway.svg", scale: "scale-100" },
  { name: "Best Buy", file: "best-buy.svg", scale: "scale-95" },
  { name: "BlackRock", file: "blackrock.svg", invert: true, scale: "scale-105" },
  { name: "Broadcom", file: "broadcom.svg", invert: true, scale: "scale-95" },
  { name: "Burger King", file: "burger-king.svg", scale: "scale-85" },
  { name: "Calvin Klein", file: "calvin-klein.svg", invert: true, scale: "scale-100" },
  { name: "Caterpillar", file: "caterpillar.svg", scale: "scale-90" },
  { name: "Chrysler", file: "chrysler.svg", scale: "scale-110" },
  { name: "Cisco", file: "cisco-systems.svg", invert: true, scale: "scale-100" },
  { name: "Citigroup", file: "citigroup.svg", scale: "scale-100" },
  { name: "Colgate-Palmolive", file: "colgate-palmolive.svg", scale: "scale-105" },
  { name: "ConocoPhillips", file: "conocophillips.svg", scale: "scale-95" },
  { name: "Costco", file: "costco.svg", scale: "scale-105" },
  { name: "CVS", file: "cvs.svg", scale: "scale-95" },
];

export const BRAND_LOGOS_ROW_2 = [
  { name: "Microsoft", file: "Microsoft_Logo_0.svg", scale: "scale-90" },
  { name: "Tesla", file: "tesla.svg", invert: true, scale: "scale-95" },
  { name: "Uber", file: "Uber_logo_2018.svg", invert: true, scale: "scale-75" },
  { name: "Walmart", file: "Walmart_logo_(2008).svg", scale: "scale-120" },
  { name: "Target", file: "Target_logo.svg", scale: "scale-120" },
  { name: "Instagram", file: "Instagram_Logo_0.svg", invert: true, scale: "scale-90" },
  { name: "YouTube", file: "YouTube_full-color_icon_(2017).svg", scale: "scale-100" },
  { name: "Airbnb", file: "airbnb.svg", invert: true, scale: "scale-95" },
  { name: "SpaceX", file: "spacex.svg", invert: true, scale: "scale-110" },
  { name: "NVIDIA", file: "nvidia.svg", invert: true, scale: "scale-100" },
  { name: "Adobe", file: "adobe.svg", invert: true, scale: "scale-90" },
  { name: "Warner Bros.", file: "Warner_Bros-_Logo_0.svg", invert: true, scale: "scale-90" },
  ...
  { name: "IBM", file: "ibm.svg", invert: true, scale: "scale-95" },
  { name: "Boeing", file: "Boeing_full_logo.svg", scale: "scale-100" },
  { name: "Chevron", file: "chevron.svg", scale: "scale-95" },
  { name: "PepsiCo", file: "PepsiCo_logo.svg", scale: "scale-100" },
  { name: "Oracle", file: "oracle.svg", invert: true, scale: "scale-95" },
  { name: "eBay", file: "ebay.svg", scale: "scale-120" },
  { name: "Rockstar Games", file: "Rockstar_Games_Logo.svg", scale: "scale-90" },
  { name: "Reddit", file: "Reddit_Logo_Icon.svg", scale: "scale-85" },
  ...
  { name: "Dow", file: "dow.svg", scale: "scale-100" },
  { name: "Eli Lilly", file: "eli-lilly-and-company.svg", scale: "scale-110" },
  { name: "General Dynamics", file: "general-dynamics.svg", invert: true, scale: "scale-100" },
  { name: "Halliburton", file: "halliburton.svg", scale: "scale-100" },
  { name: "Hilton", file: "hilton.svg", invert: true, scale: "scale-100" },
  { name: "Home Depot", file: "home-depot.svg", scale: "scale-90" },
  { name: "Honeywell", file: "honeywell.svg", scale: "scale-105" },
  { name: "HP", file: "hp.svg", scale: "scale-95" },
  { name: "Jeep", file: "jeep.svg", invert: true, scale: "scale-95" },
  { name: "John Deere", file: "john-deere.svg", scale: "scale-90" },
  { name: "KFC", file: "kfc.svg", scale: "scale-90" },
  { name: "Kroger", file: "kroger.svg", scale: "scale-100" },
  { name: "Lockheed Martin", file: "lockheed-martin.svg", invert: true, scale: "scale-100" },
  { name: "Lowe's", file: "lowes.svg", scale: "scale-100" },
  { name: "Marriott", file: "marriott-international.svg", invert: true, scale: "scale-100" },
  { name: "Medtronic", file: "medtronic.svg", invert: true, scale: "scale-100" },
  { name: "Merck", file: "merck.svg", invert: true, scale: "scale-95" },
  { name: "Moderna", file: "moderna.svg", scale: "scale-105" },
  { name: "Northrop Grumman", file: "northrop-grumman.svg", invert: true, scale: "scale-100" },
  { name: "Occidental Petroleum", file: "occidental-petroleum.svg", scale: "scale-95" },
  { name: "Paypal", file: "paypal.svg", scale: "scale-105" },
  { name: "Qualcomm", file: "qualcomm.svg", scale: "scale-100" },
  { name: "Raytheon", file: "raytheon.svg", invert: true, scale: "scale-100" },
  { name: "RTX", file: "rtx.svg", invert: true, scale: "scale-95" },
  { name: "Salesforce", file: "salesforce.svg", scale: "scale-95" },
  { name: "Stryker", file: "stryker.svg", scale: "scale-95" },
  { name: "Taco Bell", file: "taco-bell.svg", scale: "scale-90" },
  { name: "Under Armour", file: "under-armour.svg", invert: true, scale: "scale-90" },
  { name: "United Airlines", file: "united-airlines.svg", scale: "scale-105" },
  { name: "UPS", file: "ups.svg", scale: "scale-90" },
  { name: "Vans", file: "vans.svg", invert: true, scale: "scale-90" },
  { name: "Verizon", file: "verizon.svg", scale: "scale-100" },
  { name: "Wells Fargo", file: "wells-fargo.svg", scale: "scale-95" },
  { name: "The North Face", file: "the-north-face.svg", invert: true, scale: "scale-90" },
  { name: "Ticketmaster", file: "ticketmaster.svg", scale: "scale-100" },
  { name: "Booking Holdings", file: "booking-holdings.svg", scale: "scale-100" },
];
...
export const CULTURE_MEDIA_WALL_IMAGES = [
  ...
  "/images/culture/Brand Ads/1968 Chiquita banana advertisement.jpg",
  "/images/culture/Brand Ads/1968 Kentucky Fried Chicken advertisement.jpg",
  "/images/culture/Brand Ads/1979 Minute Maid Ad.jpg",
  "/images/culture/Brand Ads/1987 advertisement for Ford.jpg",
  "/images/culture/Brand Ads/1988 The Wall Street Journal advertisement.jpg",
  "/images/culture/Brand Ads/Asteroids-arcade-video-game.jpg",
  "/images/culture/Brand Ads/Converse-basketball-shoes-from-1968.jpg",
  "/images/culture/Brand Ads/Converse-shoes-by-Sears-1977.jpg",
  "/images/culture/Brand Ads/Pac-Man-arcade-video-games-from-1980.jpg",
  "/images/culture/Brand Ads/Retro-70s-corduroy-western-jeans-with-bell-bottoms-1973.jpg",
  "/images/culture/Brand Ads/Sprite-with-vodka-1966.jpg",
  "/images/culture/Brand Ads/Vintage-Lemon-Go-Lightly-for-blonde-hair-1970s.jpg",
  "/images/culture/Brand Ads/Vintage-Magic-Chef-gas-range-from-1950.jpg",
  "/images/culture/Collage/America collage Happy 4th🇺🇸 1.jpg",
  "/images/culture/Collage/America collage Happy 4th🇺🇸 2.jpg",
  "/images/culture/Collage/America collage Happy 4th🇺🇸 4.jpg",
  "/images/culture/Collage/America collage Happy 4th🇺🇸 5.jpg",
  "/images/culture/Collage/America collage Happy 4th🇺🇸.jpg",
  "/images/culture/Collage/New York collage 🇺🇸 3.jpg",
  "/images/culture/Famous People/01_walt_disney.jpg",
  "/images/culture/Famous People/02_louis_armstrong.jpg",
  "/images/culture/Famous People/03_elvis_presley.jpg",
  "/images/culture/Famous People/04_marilyn_monroe.jpg",
  "/images/culture/Famous People/05_mark_twain.jpg",
  "/images/culture/Famous People/06_muhammad_ali.jpg",
  "/images/culture/Famous People/07_michael_jackson.jpg",
  "/images/culture/Famous People/08_michael_jordan.jpg",
  "/images/culture/Famous People/09_martin_luther_king_jr.jpg",
  "/images/culture/Famous People/10_arnold_schwarzenegger.jpg",
  "/images/culture/Food/McDonald's Menu with burger and fries and soda.jpeg",
