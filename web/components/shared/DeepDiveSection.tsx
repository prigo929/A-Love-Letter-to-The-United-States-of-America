...
export interface DeepDiveTheme {
  /** Background hex — should match the page's section background */
  bg: string;
  /** Primary accent hex used for active states, headings, pull quote border */
  accent: string;
  /** Short all-caps label rendered in the section break bar */
  label: string;
  labelRo?: string;
}

// Pre-built themes for each vertical
