...
export const NATURE_OVERVIEW_FACTS: NatureFact[] = [
  ...
  { id: "economic-impact", fact: "National Parks generate $50B+ in annual economic output", detail: "Conservation is not just a moral good; it is a massive economic driver. The park system supports 378,000 jobs and provides a returns-on-investment of $10 for every $1 of federal funding.", source: "NPS Peer-Reviewed Economics 2024", color: "red" },
...
const NATURE_OVERVIEW_FACTS_RO: NatureFact[] = [
  ...
  { id: "economic-impact", fact: "Parcurile Naționale generează peste 50 mld. $ în producție economică anuală", detail: "Conservarea nu este doar un bine moral; este un motor economic masiv. Sistemul de parcuri susține 378.000 de locuri de muncă și oferă un randament al investiției de 10$ pentru fiecare 1$ de finanțare federală.", source: "NPS Peer-Reviewed Economics 2024", color: "red" },
