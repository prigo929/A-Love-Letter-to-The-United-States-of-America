...
export const metadata: Metadata = {
  title: "The Interstate Highway Network | Patriotic USA",
  description: "Explore The Interstate Highway Network and its impact on the American story.",
};
  ...
  return (
    <main className="min-h-screen bg-navy-dark pt-24 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Breadcrumb
          items={[
            { label: isRo ? "Infrastructură" : "Infrastructure", href: "/infrastructure" },
            { label: isRo ? "Sistemul de Autostrăzi Interstatale" : "The Interstate Highway Network" },
          ]}
          className="mb-8"
        />
        ...
        <div className="border border-white/10 bg-white/[0.02] rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden">
          ...
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded border border-glory-gold/30 bg-glory-gold/5 text-glory-gold text-[9px] font-bold uppercase tracking-wider mb-6">
            {isRo ? "Infrastructură" : "Infrastructure"}
          </span>
          
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {isRo ? "Sistemul de Autostrăzi Interstatale" : "The Interstate Highway Network"}
          </h1>
