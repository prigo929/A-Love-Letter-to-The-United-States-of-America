...
export const RAIL_ROUTES: NetworkRoute[] = [
  ...
  },
  {
    ...
    color: "#f87171",
    waypoints: [C.chicago, C.kansasCity, C.wichita, C.amarillo, C.clovis, C.belen, C.gallup, C.flagstaff, C.needles, C.barstow, C.losAngeles],
    endpoints: { en: "Chicago → Los Angeles", ro: "Chicago → Los Angeles" },
    lengthLabel: "≈2,200 mi",
    year: "1887",
    description: {
      en: "The Santa Fe drove southwest through Kansas cattle country and the New Mexico high desert to reach Los Angeles — the line that later carried the Super Chief, and today carries more freight than any rail corridor on Earth.",
      ro: "Santa Fe a înaintat spre sud-vest prin ținutul vitelor din Kansas și deșertul înalt din New Mexico până la Los Angeles — linia care a purtat mai târziu trenul Super Chief, iar astăzi duce mai multă marfă decât orice alt coridor feroviar de pe Pământ.",
    },
  },
  {
    id: "great-northern",
