...
export default async function CultureSportsPage() {
  ...
  const content = {
    ...
    olympicText: isRo
      ? "SUA dețin cele mai multe medalii de aur la Jocurile de Vară (1.105) și 1.219 medalii de aur în total (inclusiv cele de Iarnă), cu Uniunea Sovietică pe locul doi (473). Ceea ce face acest lucru și mai remarcabil este contextul competitiv: SUA câștigă aceste medalii printr-un infrastructură privată profundă de atletism universitar, cluburi private, sponsorizări comerciale și ambiție individuală într-o societate liberă."
      : "The US holds the most Summer gold medals overall with 1,105 (and 1,219 total gold medals overall including Winter games), with the Soviet Union in second place at 473. What makes this more remarkable is the competitive context: American Olympic success is the product of a deep private infrastructure of collegiate athletics, private clubs, commercial sponsorships, and individual ambition operating in a free society.",
    parallelQuote: isRo
      ? "Stadioanele americane sunt temple ale identității naționale, capabile să coaguleze 100.000 de oameni sub același steag în orice weekend."
      : "American stadiums stand as cathedrals of national identity, capable of gathering 100,000 fans under Friday night lights or Sunday autumn skies.",
