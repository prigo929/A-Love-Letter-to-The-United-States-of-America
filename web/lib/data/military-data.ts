...
export const MILITARY_BRANCHES: MilitaryBranch[] = [
  ...
  },
  {
    ...
    keyFacts: [
      "Operates a fleet of 250+ cutters, 1,600+ boats, and 200+ aircraft",
      "Saves an average of 10+ lives and assists 70+ people in distress every day",
      "Enforces U.S. law across more than 4.5 million square miles of Exclusive Economic Zone (EEZ)",
      "Maintains a combat-ready force that deploys globally alongside other armed forces during war",
    ],
    imageSrc: SITE_IMAGES.coastGuardHero,
    imageAlt: "U.S. Coast Guard cutter ship cutting through rough ocean waves with helicopter overhead",
  },
];
  ...
  return [
    ...
    },
    {
      ...
      keyFacts: [
        ...
        "Salvează în medie 10+ vieți și ajută 70+ persoane aflate în dificultate în fiecare zi",
        "Aplică legea SUA pe mai mult de 4,5 milioane de mile pătrate de Zonă Economică Exclusivă (ZEE)",
        "Menține o forță pregătită de luptă care se desfășoară global alături de celelalte forțe armate în caz de război",
      ],
    },
  ];
}
