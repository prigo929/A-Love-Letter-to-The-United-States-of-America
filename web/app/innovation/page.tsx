...
export default async function InnovationPage() {
  ...
  return (
    <main className="min-h-screen bg-navy-dark pt-24 text-white">
      ...
      <AskAmericaCTA
        locale={locale}
        descriptionEn="Ask the AI Oracle about Silicon Valley, internet history, artificial intelligence, smartphone developments, or space systems."
        descriptionRo="Întreabă Oracolul AI despre Silicon Valley, istoria internetului, inteligența artificială, dezvoltarea smartphone-urilor sau sistemele spațiale."
      />
    </main>
  );
}
