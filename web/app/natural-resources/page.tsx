...
export const metadata: Metadata = {
  ...
  description: "An empty layout scaffold for the Natural Resources section.",
};

export default async function NaturalResourcesPage() {
  const locale = await getServerLocale();
  const breadcrumb = locale === "ro" ? "Resurse Naturale" : "Natural Resources";
    ...
    <main className="min-h-screen bg-navy-dark pt-24 text-white">
      ...
      >
        <div className="mx-auto max-w-4xl rounded-3xl border border-dashed border-white/15 bg-white/3 p-8">
          {/* TODO: Drop in existing thesis statement on American resource abundance here */}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
            <div className="min-h-[180px] rounded-2xl border border-dashed border-white/15 bg-white/3 p-6">
              {/* TODO: Create empty cards. Drop in links to Energy Hub, Agricultural Abundance, Mineral Wealth, Water Systems here */}
            </div>
            <div className="min-h-[180px] rounded-2xl border border-dashed border-white/15 bg-white/3 p-6" />
            <div className="min-h-[180px] rounded-2xl border border-dashed border-white/15 bg-white/3 p-6" />
            <div className="min-h-[180px] rounded-2xl border border-dashed border-white/15 bg-white/3 p-6" />
