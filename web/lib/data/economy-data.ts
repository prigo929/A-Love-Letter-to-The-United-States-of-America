...
export const ECONOMY_OVERVIEW_PARAGRAPHS = [
  "The United States economy is the most powerful economic force in history, built upon a constitutional system protecting property rights, contract enforcement, and individual initiative. These foundations created conditions for sustained growth, productivity, and technological leadership.",
  "Reaching $32.4 trillion in 2026, the US economy operates at a scale distinct from every other nation. It is simultaneously the world's largest consumer market, primary financial hub, leading destination for foreign direct investment, dominant technology innovator, and issuer of the global reserve currency.",
  "This performance reflects free market principles, low regulatory friction, creative destruction, and a continuous inflow of global talent over 250 years. The American economy achieves unmatched output through free enterprise.",
];

export const GDP_OVERVIEW_PARAGRAPHS = [
  "The United States economy produces $32.4 trillion in goods and services annually, exceeding the combined output of China ($20.8T), Germany ($5.4T), and Japan ($4.4T). This accounts for approximately 25% of global economic output from 4.2% of the world's population.",
  "What makes this achievement remarkable is its durability. The United States has remained the world's largest economy for over 130 consecutive years, maintaining growth through major economic downturns, world conflicts, and global disruptions.",
];

export const CAPITAL_MARKETS_PARAGRAPHS = [
  "The New York Stock Exchange and NASDAQ represent the deepest and most transparent capital markets in human history. Combined market capitalization exceeds $69 trillion, surpassing the GDP of every nation except the United States. These markets serve as the central financing engine for American enterprise, with [Wall Street](#deep-dive-Wall_Street) as its global focal point.",
  "The US bond market, featuring $27 trillion in Treasury securities, forms the bedrock of global finance. Treasury yields serve as the reference benchmark for global asset pricing, guided by the monetary policy of the [Federal Reserve](#deep-dive-Federal_Reserve).",
];
...
export const DOLLAR_OVERVIEW_PARAGRAPHS = [
  'The US dollar serves as the operating system of global finance, functioning as the primary reserve currency and medium of exchange. Developed through the [Bretton Woods system](#deep-dive-Bretton_Woods_system) and petrodollar agreements, this status allows the United States to access competitive global borrowing rates.',
  "Today, 56.8% of global foreign exchange reserves are held in US dollars, and over 40% of international trade is invoiced in USD. Major commodities including global oil markets remain denominated in dollars, embedding structural demand into international banking.",
];

export const TRADE_OVERVIEW_PARAGRAPHS = [
  "The United States is both the world's largest importer and one of its most significant exporters, reflecting an economy that produces and consumes at exceptional volume. US merchandise exports exceed $2 trillion annually, led by aircraft, petroleum products, semiconductors, medical devices, and pharmaceuticals.",
  "Beyond goods, America leads the export of services, including financial services, software, education, and professional consulting. Institutions like JP Morgan, Goldman Sachs, McKinsey, and Harvard Business School export intellectual capital that powers economies worldwide.",
];
...
export const ECONOMY_SUB_PAGES = [
  {
    ...
    title: "GDP & Scale",
    description:
      "Analysis of the $32.4 trillion American economy",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "The world's premier equity markets and global financial hub",
    imageSrc:
  ...
  },
  {
    ...
    title: "Startups & VC",
    description: "Silicon Valley and innovation hubs funding tomorrow's technology",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "The world's reserve currency and foundation of global trade",
    imageSrc:
  ...
  },
  {
    ...
    title: "Trade & Exports",
    description: "American industrial, agricultural, and technology exports",
    imageSrc:
...
export function getEconomyOverviewParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "Economia Statelor Unite reprezintă cea mai puternică forță economică din istorie, fiind construită pe un cadru constituțional ce garantează dreptul la proprietate, executarea contractelor și inițiativa individuală. Aceste fundamente au creat condiții de durată pentru expansiune economică, productivitate și inovație.",
      "Atingând 32,4 trilioane de dolari în 2026, economia SUA funcționează la o scară net superioară oricărei alte națiuni. Este simultan cea mai mare piață de consum din lume, cel mai important centru financiar, principala destinație pentru investiții străine directe și emitentul monedei de rezervă globale.",
      "Această performanță reflectă piețele libere, barierele reduse la intrare și atragerea constantă a celor mai ambițioase talente globale de-a lungul a 250 de ani. Economia americană obține rezultate extraordinare prin libera inițiativă.",
    ];
  }
...
export function getGdpOverviewParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "Economia Statelor Unite produce anual bunuri și servicii de 32,4 trilioane de dolari, depășind producția însumată a Chinei (20,8T), Germaniei (5,4T) și Japoniei (4,4T). Aceasta reprezintă aproximativ 25% din producția economică globală, realizată de o țară ce deține 4,2% din populația lumii.",
      "Ceea ce face această realizare remarcabilă este durabilitatea ei. Statele Unite au rămas cea mai mare economie a lumii timp de peste 130 de ani consecutivi, menținând creșterea prin mari recesiuni economice, conflicte mondiale și provocări globale.",
    ];
  }
...
export function getCapitalMarketsParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "Bursa din New York și NASDAQ reprezintă cele mai adânci și transparente piețe de capital din istorie. Capitalizarea lor cumulată depășește 69 de trilioane de dolari, întrecând PIB-ul oricărei alte națiuni. Aceste piețe constituie motorul central de finanțare a companiilor, având [Wall Street](#deep-dive-Wall_Street) ca punct focal global.",
      "Piața americană de obligațiuni, cu 27 de trilioane de dolari în titluri de Trezorerie, reprezintă fundamentul finanțelor globale. Randamentele titlurilor de Trezorerie servesc drept punct de referință pentru evaluarea activelor pe piețele internaționale, coordonate de [Federal Reserve](#deep-dive-Federal_Reserve).",
    ];
  }
...
export function getVcOverviewParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "[Silicon Valley](#deep-dive-Silicon_Valley) concentrează un ecosistem masiv de venture capital extins în San Francisco, New York, Boston, Seattle, Austin și Miami. Această rețea direcționează capital de risc către inovația timpurie la o scară superioară oricărei alte regiuni.",
      "Startup-urile americane au atras aproximativ 210 miliarde de dolari în venture capital în 2025, reprezentând aproape 65% din totalul global. Acest ecosistem a generat 659 de companii unicorn. Tehnologii esențiale precum iPhone, Google Search și ChatGPT au fost dezvoltate prin acest cadru.",
    ];
  }
...
export function getDollarOverviewParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "Dolarul american funcționează ca sistem de operare al economiei globale, fiind principala monedă de rezervă și mijloc de tranzacționare. Format prin sistemul [Bretton Woods](#deep-dive-Bretton_Woods_system) și acordurile comerciale internaționale, acest statut permite Statelor Unite accesul la refinanțare globală în condiții avantajoase, sub supravegherea [Federal Reserve](#deep-dive-Federal_Reserve).",
      "Astăzi, 56,8% din rezervele valutare globale sunt deținute în dolari americani, iar peste 40% din comerțul internațional este facturat în USD. Marile resurse, inclusiv petrolul, rămân denominate în dolari, integrând cererea de USD în arhitectura financiară internațională.",
    ];
  }
...
export function getTradeOverviewParagraphs(locale: Locale) {
  if (locale === "ro") {
    return [
      "Statele Unite sunt atât cel mai mare importator din lume, cât și unul dintre cei mai importanți exportatori, reflectând o economie ce produce și consumă la volum excepțional. Exporturile americane de bunuri depășesc anual 2 trilioane de dolari, conduse de avioane, produse petroliere, semiconductori, dispozitive medicale și produse farmaceutice.",
      "Dincolo de bunuri, America domină exportul de servicii, inclusiv servicii financiare, software, educație și consultanță profesională. Firme americane precum JP Morgan, Goldman Sachs, McKinsey și Harvard Business School exportă capitalul intelectual care pune în mișcare economii din întreaga lume.",
    ];
  }
