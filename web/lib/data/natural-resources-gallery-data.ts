    ...
    },
    {
      ...
      photos: [
        ...
        { id: "corn-belt", image: agCornAerial, year: ro ? "Prezent" : "Present", title: ro ? "Centura Porumbului" : "The Corn Belt", location: "Iowa",
          caption: ro ? "Cel mai productiv și mai bogat bloc contiguu de teren agricol din istoria omenirii: un exemplu al drepturilor de proprietate și al agriculturii științifice." : "The most productive, highest-yielding contiguous block of agricultural land in human history: proof of property rights and scientific farming." },
        ...
        { id: "combine", image: agCombine, year: ro ? "Prezent" : "Present", title: ro ? "Recolta cu Combina" : "The Combine Harvest", location: "Kansas",
          caption: ro ? "Combine recoltând un câmp de grâu cu precizia unei operațiuni militare, pe proprietate privată, peste Marile Câmpii deschise." : "Combines reap a wheat field with the precision of a military operation on private property across the open Plains." },
    ...
    },
    {
      ...
      photos: [
        ...
        { id: "logging", image: wtLogging, year: "c. 1900", title: ro ? "Exploatarea Pacificului de Nord-Vest" : "Logging the Pacific Northwest", location: ro ? "Washington" : "Washington",
          caption: ro ? "Tăietori de lemne lângă un brad Douglas uriaș: rezervele de cherestea care au construit milioane de case americane accesibile." : "Lumberjacks beside a massive Douglas fir: the timber reserves milled to build millions of affordable homes across the continent." },
