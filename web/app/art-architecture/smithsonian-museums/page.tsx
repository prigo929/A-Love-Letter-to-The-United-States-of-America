...
export const metadata: Metadata = {
  title: "The Smithsonian & Great Museums | Patriotic USA",
  description: "Explore The Smithsonian & Great Museums and its impact on the American story.",
};
  ...
  return (
    <main className="min-h-screen bg-navy-dark pt-24 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Breadcrumb
          items={[
            { label: isRo ? "Artă & Arhitectură" : "Art & Architecture", href: "/art-architecture" },
            { label: isRo ? "Smithsonian și Marile Muzee" : "The Smithsonian & Great Museums" },
          ]}
          className="mb-8"
        />
        ...
        <div className="border border-white/10 bg-white/[0.02] rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {isRo ? "Smithsonian și Marile Muzee" : "The Smithsonian & Great Museums"}
          </h1>
