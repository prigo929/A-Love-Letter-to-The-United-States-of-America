...
export function getMilitaryPageCopy(locale: Locale) {
  if (locale === "ro") {
    return {
      ...
      carrierLabel: "SUPERIORITATE NAVALĂ · RAZĂ GLOBALĂ",
      carrierTitle1: "11 GRUPURI DE",
      carrierTitle2: "ATAC",
      carrierSub: "Desfășurate simultan pe fiecare ocean de pe Pământ",
      carrierLiveLabel: "DESFĂȘURAREA GRUPURILOR DE PORTAVIOANE · POZIȚII LIVE",
  ...
  return {
    ...
    carrierLabel: "NAVAL SUPERIORITY · GLOBAL REACH",
    carrierTitle1: "11 CARRIER",
    carrierTitle2: "STRIKE GROUPS",
    carrierSub: "Simultaneously deployed across every ocean on earth",
    carrierLiveLabel: "CARRIER GROUP DEPLOYMENT · LIVE POSITIONS",
