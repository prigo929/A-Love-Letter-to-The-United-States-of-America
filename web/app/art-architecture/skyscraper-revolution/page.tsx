...
export const metadata: Metadata = {
  title: "The Skyscraper Revolution | Patriotic USA",
  description: "Explore The Skyscraper Revolution and its impact on the American story.",
};
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Breadcrumb
          items={[
            ...
            { label: isRo ? "Revoluția Zgârie-Norilor" : "The Skyscraper Revolution" },
          ]}
          className="mb-8"
        />
        ...
        <div className="border border-white/10 bg-white/[0.02] rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {isRo ? "Revoluția Zgârie-Norilor" : "The Skyscraper Revolution"}
          </h1>
