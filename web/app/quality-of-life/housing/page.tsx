...
const copyEn: HousingCopy = {
  ...
  thesisParagraph1:
    "American homes are the largest in the world by floor space per person, roughly double the size of a German home and triple that of a Japanese one. This is the statistical median for the American working and middle class, not a luxury reserved for the wealthy. The US housing market sits atop deep capital markets, government-sponsored secondary mortgage entities (Fannie Mae, Freddie Mac), and a uniquely American financial instrument: the 30-year fixed-rate mortgage.",
  thesisParagraph2:
