...
const ALASKA_EXTENDED_FACTS_EN = [
  { id: "ak-coastline",    fact: "Alaska has more coastline than the rest of the US combined",          detail: "Alaska's 33,904 miles of tidal shoreline represent more coastal length than all other US states combined: fjords, sea stacks, glacial inlets, and remote beaches.", source: "NOAA", color: "red"  as const },
  ...
  { id: "ak-size-compare", fact: "Alaska is larger than TX + CA + MT combined: by 83,000 square miles", detail: "Texas (268,596 mi²) + California (163,696 mi²) + Montana (147,040 mi²) = 579,332 mi². Alaska at 663,268 mi² beats all three combined, placing it in a category entirely its own.", source: "US Census Bureau", color: "blue" as const },
];
...
const ALASKA_EXTENDED_FACTS_RO = [
  ...
  { id: "ak-size-compare", fact: "Alaska este mai mare decât TX + CA + MT la un loc: cu 133.000 km² în plus", detail: "Texas + California + Montana = 1.500.600 km². Alaska la 1.717.854 km² le depășește pe toate trei combinate, având o scară geografică excepțională.", source: "US Census Bureau", color: "blue" as const },
];
