...
const MILITARY: IconicPhoto[] = [
  ...
  },
  {
    ...
    year: "2020",
    caption: "U.S. Air Force F-22 Raptor, pulls into a maximum vertical climb during an aerial demonstration at Joint Base Langley-Eustis, Va., March 30, 2020.",
    description:
      "A U.S. Air Force F-22 Raptor pulls into a maximum vertical climb during an aerial demonstration at Joint Base Langley-Eustis, Virginia, showcasing the extreme maneuverability and thrust-vectoring power of America's premier air-superiority stealth fighter.",
    category: "Military",
    section: "military",
    location: "Joint Base Langley-Eustis, Virginia",
    rights: "public-domain",
    source: "U.S. Air Force / DoD (PD).",
    imagePath: "Military/Air Force/U.S. Air Force F-22 Raptor, pulls into a maximum vertical climb during an aerial demonstration at Joint Base Langley-Eustis, Va., March 30, 2020.jpg",
  },
  {
  ...
  {
    id: "uss-arizona-explosion-pearl-harbor",
    title: "The Explosion of the USS Arizona at Pearl Harbor",
    year: "1941",
    caption: "The battleship USS Arizona explodes during the attack on Pearl Harbor.",
    description:
      "Captured on December 7, 1941, this photograph shows the catastrophic explosion of the battleship USS Arizona's forward magazines after being hit by Japanese bomb attacks, drawing the United States into World War II.",
    category: "Military",
    section: "military",
    location: "Pearl Harbor, Hawaii",
    rights: "public-domain",
    source: "US Navy / National Archives (PD).",
    imagePath: "History/WWII/Explosion of the battleship USS Arizona at Pearl Harbor.jpg",
  },
  {
    id: "b-17-bomber-stream",
    title: "B-17 Flying Fortress Bomber Stream",
    year: "1943",
    caption: "Part of a massive 1,000-ship B-17 Flying Fortress bomber stream.",
    description:
      "The Boeing B-17 Flying Fortress was the backbone of the U.S. Army Air Forces' daylight strategic bombing campaign over occupied Europe, operating in massive, highly coordinated formations to defeat Nazi industrial infrastructure.",
    category: "Military",
    section: "military",
    location: "Over Occupied Europe",
    rights: "public-domain",
    source: "US Army Air Forces (PD).",
    imagePath: "History/WWII/Part of a 1,000-ship B-17 Flying Fortress bomber stream during World War II.jpg",
  },
  {
    id: "flying-tigers-hells-angels",
    title: "The Flying Tigers over China",
    year: "1942",
    caption: "Hell's Angels squadron of the 1st American Volunteer Group in flight.",
    description:
      "The 'Flying Tigers' of the 1st American Volunteer Group defended China against Japanese forces prior to and during the early stages of U.S. entry into World War II, achieving legendary status with their shark-faced P-40 fighters.",
    category: "Military",
    section: "military",
    location: "China",
    rights: "public-domain",
    source: "1st AVG (PD).",
    imagePath: "History/WWII/Hell's Angels, the 3rd Squadron of the 1st American Volunteer Group Flying Tigers, 1942 in air.jpg",
  },
  {
    id: "101st-airborne-bastogne",
    title: "The 101st Airborne Breaking Out of Bastogne",
    year: "1944",
    caption: "Troops of the 101st Airborne Division move out after the siege is lifted.",
    description:
      "Encircled by German forces during the Battle of the Bulge in December 1944, the 101st Airborne Division famously held the vital crossroads town of Bastogne in freezing conditions, refusing to surrender and blunting the German offensive.",
    category: "Military",
    section: "military",
    location: "Bastogne, Belgium",
    rights: "public-domain",
    source: "US Army (PD).",
    imagePath: "History/WWII/Troops of the 101st Airborne move out of Bastogne, after having been besieged there for ten days, 31 December 1944.jpg",
  },
  {
    id: "uss-bunker-hill-kamikaze",
    title: "Kamikaze Strike on the USS Bunker Hill",
    year: "1945",
    caption: "The aircraft carrier USS Bunker Hill burns after being hit by two kamikazes.",
    description:
      "During the Battle of Okinawa on May 11, 1945, two Japanese kamikaze suicide aircraft struck the USS Bunker Hill within 30 seconds, causing severe damage, killing 387 crewmen, and highlighting the fierce resistance in the Pacific.",
    category: "Military",
    section: "military",
    location: "Off Okinawa, Pacific Ocean",
    rights: "public-domain",
    source: "US Navy (PD).",
    imagePath: "History/WWII/USS Bunker Hill burns after being hit by two kamikazes. At Okinawa, the kamikazes caused 4,900 American deaths.jpg",
  },
  {
    id: "trinity-test-detonation",
    title: "The Trinity Test Detonation",
    year: "1945",
    caption: "The first detonation of a nuclear weapon, July 16, 1945.",
    description:
      "The Manhattan Project culminated in the Trinity test at Alamogordo, New Mexico, marking the birth of the nuclear age and proving the viability of plutonium implosion technology before its deployment to end the war.",
    category: "Military",
    section: "military",
    location: "Alamogordo, New Mexico",
    rights: "public-domain",
    source: "US Army / Manhattan District (PD).",
    imagePath: "History/WWII/Manhattan Project/The Trinity test of the Manhattan Project was the first detonation of a nuclear weapon.jpg",
  },
  {
    id: "fdr-signing-lend-lease",
    title: "FDR Signing the Lend-Lease Bill",
    year: "1941",
    caption: "President Roosevelt signs the Lend-Lease bill to aid Allied nations.",
    description:
      "In March 1941, President Franklin D. Roosevelt signed the Lend-Lease Act, transforming the United States into the 'Arsenal of Democracy' by providing vital military aid to Britain, China, and later the Soviet Union.",
    category: "Military",
    section: "military",
    location: "Washington, D.C.",
    rights: "public-domain",
    source: "National Archives (PD).",
    imagePath: "History/WWII/Lend-Lease/President Roosevelt signs the Lend-Lease bill to give aid to Britain and China (March 1941).jpg",
  },
];
