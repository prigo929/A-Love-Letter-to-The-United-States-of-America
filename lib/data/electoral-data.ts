...
const ELECTIONS: Record<number, ElectionRecord> = {
  ...
  1912: { winner: "DEM", loser: "PROG", winnerStates: NAMES.filter(n => (STATE_ADMISSION[n]||9999) <= 1912 && !["California","Michigan","Minnesota","Pennsylvania","South Dakota","Washington"].includes(n) && !["Utah","Vermont"].includes(n)), anomalies: { "California": "PROG", "Michigan": "PROG", "Minnesota": "PROG", "Pennsylvania": "PROG", "South Dakota": "PROG", "Washington": "PROG" }, thirdPartyCandidates: { "PROG": "Theodore Roosevelt" }, note: "Wilson; TR splits GOP" },
