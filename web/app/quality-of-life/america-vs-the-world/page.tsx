...
const copyEn: VersusCopy = {
  ...
  benchmarksIntro:
    "The honest version of the comparison includes the sophisticated competitors alongside standard examples. Region by region, the same conclusion keeps surfacing: institutions, not geography or resources, set the ceiling.",
  benchmarks: [
  ...
  return (
    <>
      ...
      <div className="bg-[#000000] relative z-10 pb-32 font-body text-white">
        ...
        {/* Beyond Houston: cities */}
        <RevealSection className="border-b border-white/5 px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <span className="macro-eyebrow">{isRo ? "DINCOLO DE HOUSTON" : "BEYOND HOUSTON"}</span>
